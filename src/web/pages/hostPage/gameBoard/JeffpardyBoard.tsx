    ...
    implements IJeffpardyBoard
{
    ...
    public render() {
        ...
        if (this.state.activeClue != null && this.state.activeClue.isDailyDouble) {
            ...
            <div id="jeffpardyBoardFrame">
                <div id="jeffpardyBoardInnerFrame">
                    <div id="jeffpardyBoard">
                        {this.state.jeopardyBoardView == JeopardyBoardView.Board && (
                            <div className="jeffpardyBoardClues">{boardGridElements}</div>
                        )}
                                ...
                                <div className="jeffpardyBoardClues categoryRevealBoard">
                                    ...
                                    {this.props.categories.map((cat, i) =>
                                        cat.clues.map((clue, j) => {
                                            ...
                                            const isRevealed =
                                                this.props.round > 0 || this.state.boardFillRevealed.has(cellIndex);
                                            return (
                                                <div
                                                    key={`${i}-${j}`}
                            ...
                            this.state.revealCategoryIndex >= 0 && (
                                <div className="categoryRevealFilmstrip">
                                    <div
                                        ...
                                        style={{ transform: `translateX(-${this.state.revealCategoryIndex * 100}%)` }}
                                    >
                                        {this.props.categories.map((cat, i) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <div className="categoryRevealTitleContainer">
                                                        ...
                                                        >
                                                            <img
                                                                src={this.getRoundLogoSrc()}
                                                                className="categoryRevealLogo"
                                                            />
                                                        </div>
                                                        <div
                                                            className={
                                                                "categoryRevealTitle categoryRevealNameText" +
                                                                (showName ? " visible" : "")
                                                            }
                                                        >
                                                            {cat.title}
                        ...
                        {(this.state.jeopardyBoardView == JeopardyBoardView.Clue ||
                            ...
                            <div className="jeffpardyActiveClue">
                                <div className="header">
                                    {this.state.activeCategory.title} for {this.state.activeClue.value}
                                </div>
                                <div
                                    className="clue"
                                    dangerouslySetInnerHTML={{
                                        __html: "<span>" + this.state.activeClue.clue + "</span>",
                                    }}
                                ></div>
                                <div
                                    className="question"
                                    dangerouslySetInnerHTML={{
                                        __html:
                                            "<span>" +
                                            (this.state.jeopardyBoardView == JeopardyBoardView.Question
                                                ? this.state.activeClue.question
                                                : "\u00A0") +
                                            "</span>",
                                    }}
                                ></div>
                        ...
                        {this.state.jeopardyBoardView == JeopardyBoardView.DailyDouble && (
                            <div className="jeffpardyActiveClue dailyDoubleView">
                                ...
                                <img
                                    ...
                                    className={"dailyDoubleImage" + (this.state.dailyDoubleRevealed ? " faded" : "")}
                                />
                                <div
                                    className={
                                        "dailyDoubleContent" + (this.state.dailyDoubleRevealed ? " visible" : "")
                                    }
                                >
                                    <div className="header">
                                        {this.state.activeCategory.title} for {this.state.activeClue.value}
                                    ...
                                    <div className="dailyDouble">
                                        ...
                                        <div className="wager">
                                            ...
                                            <div className="wagerInputContainer">
                                                <input
                                                    ...
                                                    onChange={(e) => {
                                                        this.dailyDoubleBetTemp = e.target.value;
                                                    }}
                                                />
                                        ...
                                        <button
                                            onClick={() => {
                                                this.validateAndSubmitDailyDoubleBet(dailyDoubleMaxBet);
                                            }}
                                        >
                                            Submit
                                        </button>
